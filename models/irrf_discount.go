...
var (
	IRRF_RANGE_1 = NewIRRFRange(decimal.Zero, decimal.NewFromFloat(1903.98), decimal.Zero, decimal.Zero)
	IRRF_RANGE_2 = NewIRRFRange(decimal.NewFromFloat(1903.98), decimal.NewFromFloat(2826.65), decimal.NewFromFloat(0.075), decimal.NewFromFloat(142.80))
